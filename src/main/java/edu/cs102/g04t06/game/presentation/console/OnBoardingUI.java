 ...
 */
public class OnBoardingUI extends BaseStack implements StylingSheet{
    ...
    public OnBoardingUI(App application) {
        super(BG_IMAGE_URL, application); // calls BaseStack constructor with background image and app instance
